...
export async function obtenerCotizaciones(
  params: Partial<WsBcuCotizacionesIn> = {}
) {
...
export type BcuErrorMessage = (typeof errorCodes)[ErrorCode];
...
function handleError(result: any) {
  ...
  const errorMessage =
    errorCodes[errorCode as keyof typeof errorCodes] || "UNKNOWN_ERROR";
